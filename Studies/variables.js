...
// Declaration 
// At the declaration phase either var, let, or const should be used to declare the variable. Following the key word a space should be used, followed by a name that has correlation
var age; 

// Assignment
// age is now assigned the number 35 as its value
age = 35;
